...
public class edit_delete_bloodpressure extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateButton = findViewById(R.id.startButton_bp);
        endDateButton = findViewById(R.id.endButton_newBP);
        frequencyBP = findViewById(R.id.frequency_spinner_edit_oneBP);
        timeButtonBPLater = findViewById(R.id.timeButton_editBP);
        saveBPbutton = findViewById(R.id.save_changes_button);
        ...
        deleteBP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(edit_delete_bloodpressure.this);
        ...
        fstore.collection("users").document(currentFirebaseUser.getUid()).collection("Health Measurement Alarm").document(measurement_info_today.getId()).delete()
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            Toast.makeText(edit_delete_bloodpressure.this, "Deleted Alarm", Toast.LENGTH_LONG).show();
