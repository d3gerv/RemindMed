...
public class pdf_bodyTemp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdf_body_temp);
        ...
        myAdapter = new pdfAdapter(pdf_bodyTemp.this, myArrayList);
        ...
        savePDF = (Button) findViewById(R.id.btnSavePDF_Temp);
        savePDF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    Toast.makeText(pdf_bodyTemp.this, "No data to turn to PDF", Toast.LENGTH_SHORT).show();
...
//                holder.itemView.destroyDrawingCache();
    ...
    private void createPdf(View title, Bitmap measurements, Bitmap header){
        ...
        canvas.drawText("Report for Body Temperature",20,90,paint);
        ...
        File filePath = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) , "RemindMedTemp.pdf");
        try {
    ...
    public void pdftemp_To_hhm(View view) {
        Intent intent = new Intent(pdf_bodyTemp.this, health_measurement_pdf_choices.class);
