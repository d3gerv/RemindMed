...
public class pdf_hours_of_sleep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new pdfAdapter(pdf_hours_of_sleep.this, myArrayList);
...
//                holder.itemView.destroyDrawingCache();
    ...
    private void createPdf(View title, Bitmap measurements, Bitmap header){
        ...
        File file = new File(folder,"RemindMedSleep.pdf");
        if (!file.exists()) {
            file.mkdirs();
        }
        String targetPdf = folder + "RemindMedSleep"  + ".pdf";
        File filePath = new File(this.getExternalFilesDir("/"), "RemindMedSleep.pdf");
        try {
