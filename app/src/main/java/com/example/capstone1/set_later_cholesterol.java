...
public class set_later_cholesterol extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_later_cholesterol);


        dateButton = findViewById(R.id.duration_start_chokesterol_later);
        endDateButton = findViewById(R.id.duration_end_cholesterol_later);
        frequencyBP = findViewById(R.id.frequency_set_later_cholesterol);
        timeButtonBPLater = findViewById(R.id.time_later_cholesterol);
        saveCholbutton = findViewById(R.id.save_cholesterol_later);
        ...
        ArrayAdapter<String> adapterFrequency = new ArrayAdapter<String>(set_later_cholesterol.this,
