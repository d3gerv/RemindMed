...
public class set_later_pulse_rate extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    int choice, frequencychoide;
    private Button dateButton, endDateButton, timeButtonBPLater, saveprbutton;
    final int start = 1;
    final int end = 2;
    int id ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_later_pulse_rate);


        dateButton = findViewById(R.id.duration_start_pr_later);
        endDateButton = findViewById(R.id.duration_end_pr_later);
        frequencyBP = findViewById(R.id.frequency_set_later_pr);
        timeButtonBPLater = findViewById(R.id.time_later_pr);
        saveprbutton = findViewById(R.id.save_pr_later);
        ...
        ArrayAdapter<String> adapterFrequency = new ArrayAdapter<String>(set_later_pulse_rate.this,
    ...
    public void laterpulse_To_lhm(View view) {
        Intent intent = new Intent(set_later_pulse_rate.this, setLaterHM.class);
