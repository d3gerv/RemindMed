...
public class pdf_cholesterol extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdf_cholesterol);
        ...
        myAdapter = new pdfAdapter(pdf_cholesterol.this, myArrayList);
        ...
        savePDF = (Button) findViewById(R.id.btnSavePDF_CL);
        savePDF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    Toast.makeText(pdf_cholesterol.this, "No data to turn to PDF", Toast.LENGTH_SHORT).show();
    ...
    private void showTable() {
        ...
        db.document("users/" + currentFirebaseUser.getUid()).collection("New Health Measurements")
                .document("Cholesterol").collection("Cholesterol")
...
//                holder.itemView.destroyDrawingCache();
    ...
    private void createPdf(View title, Bitmap measurements, Bitmap header){
        ...
        canvas.drawText("Report for Cholesterol",20,90,paint);
        ...
        canvas.drawBitmap(measurements, null, new Rect(0, title.getHeight()+70, measurements.getWidth()-200,measurements.getHeight()+170), null);// finish the page
        document.finishPage(page);
        // draw text on the graphics object of the page

        // write the document content
        File folder = getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS);
        File file = new File(folder,"RemindMedChol.pdf");
        if (!file.exists()) {
            file.mkdirs();
        }
    ...
    public void pdfchol_To_hhm(View view) {
        Intent intent = new Intent(pdf_cholesterol.this, health_measurement_pdf_choices.class);
