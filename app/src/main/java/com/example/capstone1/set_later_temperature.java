...
public class set_later_temperature extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {

    int choice, frequencychoide;
    private Button dateButton, endDateButton, timeButtonBPLater, saveCholbutton;
    final int start = 1;
    final int end = 2;
    int id ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_later_temperature);

        dateButton = findViewById(R.id.duration_start_temp_later);
        endDateButton = findViewById(R.id.duration_end_later_temp);
        frequencyBP = findViewById(R.id.frequency_set_later_temp);
        timeButtonBPLater = findViewById(R.id.time_later_temp);
        saveCholbutton = findViewById(R.id.save_temp_later);
        ...
        ArrayAdapter<String> adapterFrequency = new ArrayAdapter<String>(set_later_temperature.this,
            ...
            public void onClick(View v) {
                try{
                    ...
                    if (myAlarmDate.getTimeInMillis() < System.currentTimeMillis()) {
                        Toast.makeText(set_later_temperature.this, "Set the time and date to the future", Toast.LENGTH_LONG).show();
                        return;
                    }
                    else
                    {
                    ...
                    fstore.collection("users").document(userId).collection("Health Measurement Alarm")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                ...
                                public void onSuccess(DocumentReference documentReference) {
                                    Toast.makeText(set_later_temperature.this, "New HM added", Toast.LENGTH_SHORT).show();
                                }
                            })
                    ...
                    Toast.makeText(set_later_temperature.this, "Please input data in all fields", Toast.LENGTH_SHORT).show();
    ...
    public void latertemp_To_lhm(View view) {
        Intent intent = new Intent(set_later_temperature.this, setLaterHM.class);
